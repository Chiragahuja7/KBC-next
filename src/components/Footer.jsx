  ...
  <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
    ...
    <div>
      ...
      <div className="flex gap-3 mt-5">
        <div className="w-9 h-9 flex items-center justify-center border border-white rounded-full cursor-pointer hover:bg-white transition" style={{ '--hover-text-color': 'var(--primary)' }}>
          <i className="fab fa-facebook-f text-sm group-hover:text-[var(--hover-text-color)]"></i>
        </div>
