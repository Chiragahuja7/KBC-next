    ...
    <>
      ...
      <div className="text-black m-9 p-9 gap-1 grid grid-cols-1 md:grid-cols-2">
        <div className="">
          ...
          <p className="text-gray-500 underline pt-2 pb-1"><a href="tel:+91-7627027559">+91-7627027559</a></p>
          <p className="text-gray-500 underline pb-1">Email: <a href="mailto:kunjbiharicollections20@gmail.com">kunjbiharicollections20@gmail.com</a></p>
          <p className="text-gray-500 pb-1">Opening hours: Mon-Sun 9:00am - 8:00pm</p>
          <span className="font-bold pb-1">Bulk Order:</span>
          <p className="text-gray-500 underline pb-1 pt-1">Email: <a href="mailto:kunjbiharicollections20@gmail.com">kunjbiharicollections20@gmail.com</a></p>
